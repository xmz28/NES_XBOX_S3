...
/* Modern toolchains may include the C allocation declarations after this
 * header.  memguard intentionally replaces malloc/free with macros, so make
 * sure the declarations have already been parsed before those macros exist. */
#include <stdlib.h>
#include <string.h>
